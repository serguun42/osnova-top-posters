    ...
    <footer className="footer">
      <section className="footer__section footer__section--logo">
        <img
          ...
          draggable="false"
          onContextMenu={() => false}
          alt={`${process.env.REACT_APP_SITE_SHORT} Top Posters`}
        />
        <div className="footer__logo-desc">
          <div className="footer__logo-desc__title default-title-font">
            {process.env.REACT_APP_SITE_SHORT} Top Posters
          </div>
          <div>
      ...
      <section className="footer__section">
        <div className="footer__section__item">
          ...
          <a href="https://github.com/serguun42/osnova-top-posters" target="_blank" rel="noopener noreferrer">
            Github
          </a>
        </div>
      </section>
